...
describe('SortedQueue', () => {
  it('stores elements in the correct order', () => {
    ...
    expect(f(queue.elements)).toMatchInlineSnapshot('"1, 2, 3, 3, 4, 10"')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('1')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('2')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('3')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('3')
    expect(f(queue.elements)).toMatchInlineSnapshot('"4, 10"')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('4')
    expect(queue.removeMinimum()).toMatchInlineSnapshot('10')
